			...
			<ul class="gallery popup-gallery gallery-3col">
				<li>
					<a href="img/campus/1.jpg" title="Photo 1">
						<img src="<?php echo base_url('assets/wsfront') ?>/img/campus/1.jpg" alt=""/>
						<div class="overlay">
							<span class="zoom">
				...
				<li>
					<a href="img/campus/2.jpg" title="Photo 2">
						<img src="<?php echo base_url('assets/wsfront') ?>/img/campus/2.jpg" alt=""/>
						<div class="overlay">
							<span class="zoom">
								<i class="fa fa-search"></i>
							</span>
				...
				<li>
					<a href="img/campus/3.jpg" title="Photo 3">
						<img src="<?php echo base_url('assets/wsfront') ?>/img/campus/3.jpg" alt=""/>
						<div class="overlay">
							<span class="zoom">
								<i class="fa fa-search"></i>
							</span>
				...
				<li>
					<a href="img/campus/4.jpg" title="Photo 4">
						<img src="<?php echo base_url('assets/wsfront') ?>/img/campus/4.jpg" alt=""/>
						<div class="overlay">
							<span class="zoom">
								<i class="fa fa-search"></i>
							</span>
				...
				<li>
					<a href="img/campus/3.jpg" title="Photo 7">
						<img src="<?php echo base_url('assets/wsfront') ?>/img/campus/3.jpg" alt=""/>
						<div class="overlay">
							<span class="zoom">
								<i class="fa fa-search"></i>
				...
				<li>
					<a href="img/campus/4.jpg" title="Photo 8">
						<img src="<?php echo base_url('assets/wsfront') ?>/img/campus/4.jpg" alt=""/>
						<div class="overlay">
							<span class="zoom">
								<i class="fa fa-search"></i>
				...
				<li>
					<a href="img/campus/3.jpg" title="Photo 11">
						<img src="<?php echo base_url('assets/wsfront') ?>/img/campus/3.jpg" alt=""/>
						<div class="overlay">
							<span class="zoom">
								<i class="fa fa-search"></i>
				...
				<li>
					<a href="img/campus/4.jpg" title="Photo 12">
						<img src="<?php echo base_url('assets/wsfront') ?>/img/campus/4.jpg" alt=""/>
						<div class="overlay">
							<span class="zoom">
								<i class="fa fa-search"></i>
